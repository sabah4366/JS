...
// print comedy genres movie 

movies.filter(mv=>mv.genres.includes('Comedy')).forEach(n=>console.log(n.title))

// number of movie released in 2001
console.log("number of movie released in 2011");
var num=movies.filter(mv=>mv.year=="2011")
console.log(num.length);


// is there any movie released in 2020
console.log(movies.some(mv=>mv.year=='2020'))



// longest runtime movie

console.log(movies.reduce((mv1,mv2)=>Number(mv1.runtime)>Number(mv2.runtime)?mv1:mv2))